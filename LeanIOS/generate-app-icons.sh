...
pngcrush -q -rem allb -brute -reduce -ow $BASEDIR/Images.xcassets/AppIcon.appiconset/icon-29.png 2>&1
pngcrush -q -rem allb -brute -reduce -ow $BASEDIR/Images.xcassets/AppIcon.appiconset/icon-40.png 2>&1
pngcrush -q -rem allb -brute -reduce -ow $BASEDIR/Images.xcassets/AppIcon.appiconset/icon-58.png 2>&1
pngcrush -q -rem allb -brute -reduce -ow $BASEDIR/Images.xcassets/AppIcon.appiconset/icon-76.png 2>&1
pngcrush -q -rem allb -brute -reduce -ow $BASEDIR/Images.xcassets/AppIcon.appiconset/icon-80.png 2>&1
pngcrush -q -rem allb -brute -reduce -ow $BASEDIR/Images.xcassets/AppIcon.appiconset/icon-120.png 2>&1
pngcrush -q -rem allb -brute -reduce -ow $BASEDIR/Images.xcassets/AppIcon.appiconset/icon-152.png 2>&1
pngcrush -q -rem allb -brute -reduce -ow $BASEDIR/Images.xcassets/AppIcon.appiconset/icon-180.png 2>&1
